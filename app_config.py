...
# - User.Read.All: Read full profiles of all users (requires admin consent)
# - Directory.Read.All: Read directory data (requires admin consent)
# - Mail.Read: Read user mail
# - email: View users' email
#
# Note: The following scopes are automatically included by MSAL:
# - profile
# - offline_access
# - openid
SCOPE = [
    ...
    "User.Read.All",        # Detailed profiles of all users (admin consent required)
    "Directory.Read.All",   # Directory data (admin consent required)
    "Mail.Read",           # Read user mail
    "email"                # View users' email
]
